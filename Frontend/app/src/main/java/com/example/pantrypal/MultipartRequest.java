 ...
 **/
 public class MultipartRequest extends Request<String> {
    ...
    public MultipartRequest(int method, String url, byte[] imageData, String imageFilename, Response.Listener<String> listener, Response.ErrorListener errorListener) {
    ...
    public byte[] getBody() {
        ...
        try {
            ...
            dos.writeBytes("Content-Disposition: form-data; name=\"image\";filename=\"" + imageFilename +"\"" + mLineEnd);
